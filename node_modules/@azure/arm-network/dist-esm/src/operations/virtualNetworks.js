...
export class VirtualNetworksImpl {
    ...
    listUsagePagingAll(resourceGroupName, virtualNetworkName, options) {
        return __asyncGenerator(this, arguments, function* listUsagePagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listUsagePagingPage(resourceGroupName, virtualNetworkName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    listDdosProtectionStatusPagingAll(resourceGroupName, virtualNetworkName, options) {
        return __asyncGenerator(this, arguments, function* listDdosProtectionStatusPagingAll_1() {
            var _a, e_4, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listDdosProtectionStatusPagingPage(resourceGroupName, virtualNetworkName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
