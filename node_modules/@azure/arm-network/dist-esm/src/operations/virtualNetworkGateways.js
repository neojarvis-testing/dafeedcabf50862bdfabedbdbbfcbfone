...
export class VirtualNetworkGatewaysImpl {
    ...
    listConnectionsPagingAll(resourceGroupName, virtualNetworkGatewayName, options) {
        return __asyncGenerator(this, arguments, function* listConnectionsPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listConnectionsPagingPage(resourceGroupName, virtualNetworkGatewayName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
