...
describe("Authentication", () => {
    ...
    it("token authentication works", async function () {
        ...
        const client = new AppConfigurationClient(credsAndEndpoint.endpoint, credsAndEndpoint.credential, recorder.configureClientOptions({}));
...
describe("AppConfigurationClient constructor error cases", () => {
    ...
    it("undefined connection string gives a decent error message", () => {
        assert.throws(() => new AppConfigurationClient(undefined), /Invalid connection string\. Valid connection strings should match the regex 'Endpoint=\(\.\*\);Id=\(\.\*\);Secret=\(\.\*\)'/);
    });
});
