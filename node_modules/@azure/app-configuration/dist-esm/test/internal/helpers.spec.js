...
import { checkAndFormatIfAndIfNoneMatch, extractAfterTokenFromLinkHeader, extractAfterTokenFromNextLink, formatFieldsForSelect, formatFiltersAndSelect, makeConfigurationSettingEmpty, quoteETag, serializeAsConfigurationSettingParam, transformKeyValue, transformKeyValueResponse, transformKeyValueResponseWithStatusCode, } from "../../src/internal/helpers";
import { assert } from "chai";
describe("helper methods", () => {
    it("checkAndFormatIfAndIfNoneMatch", () => {
        const key = "ignored";
        const object = { key };
        const objectWithEtag = { key, etag: "hello" };
        assert.deepEqual({
            ifMatch: undefined,
    ...
    it("checkAndFormatIfAndIfNoneMatch - mutually exclusive", () => {
        const key = "ignored";
        const objectWithEtag = { key, etag: "won't get used" };
        assert.throws(() => checkAndFormatIfAndIfNoneMatch(objectWithEtag, {
            onlyIfChanged: true,
            onlyIfUnchanged: true,
