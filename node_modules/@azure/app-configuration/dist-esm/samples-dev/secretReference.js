...
export async function main() {
    ...
    const { name: secretName, vaultUrl } = parseKeyVaultSecretIdentifier(parsedSecretReference.value.secretId);
...
async function createConfigSetting(key, secretId) {
    ...
    await cleanupSampleValues([key], appConfigClient);
    console.log(`Add a new secretReference with key: ${key} and secretId: ${secretReference.value.secretId}`);
