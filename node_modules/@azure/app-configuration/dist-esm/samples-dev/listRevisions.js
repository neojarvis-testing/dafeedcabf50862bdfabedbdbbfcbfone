...
export async function main() {
    ...
    try {
        ...
        for (var _d = true, revisionsIterator_1 = __asyncValues(revisionsIterator), revisionsIterator_1_1; revisionsIterator_1_1 = await revisionsIterator_1.next(), _a = revisionsIterator_1_1.done, !_a; _d = true) {
            _c = revisionsIterator_1_1.value;
            _d = false;
            const revision = _c;
        ...
        try {
            if (!_d && !_a && (_b = revisionsIterator_1.return)) await _b.call(revisionsIterator_1);
        }
