...
describe.skip("Compute test", () => {
    ...
    it("availabilitySets list test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var _d = true, _e = __asyncValues(client.availabilitySets.list(resourceGroupName)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const item = _c;
                    resArray.push(item);
    ...
    it("virtualMachines delete test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert.equal(resArray.length, 0);
            yield client.disks.beginDeleteAndWait(resourceGroupName, "myVMosdisk", testPollingOptions);
            yield network_client.networkInterfaces.beginDeleteAndWait(resourceGroupName, interface_name, testPollingOptions);
            yield network_client.subnets.beginDeleteAndWait(resourceGroupName, network_name, subnet_name, testPollingOptions);
            yield network_client.virtualNetworks.beginDeleteAndWait(resourceGroupName, network_name, testPollingOptions);
        });
    });
});
