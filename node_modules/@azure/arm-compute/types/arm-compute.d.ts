...
export declare interface EventGridAndResourceGraph {
 ...
 * **All**
 */
export declare type ResourceIdOptionsForGetCapacityReservationGroups = string;
...
export declare interface ScheduledEventsAdditionalPublishingTargets {
...
export declare interface ScheduledEventsPolicy {
...
export declare interface UserInitiatedReboot {
    /** Specifies Reboot Scheduled Event related configurations. */
    automaticallyApprove?: boolean;
}

/** Specifies Redeploy related Scheduled Event related configurations. */
export declare interface UserInitiatedRedeploy {
