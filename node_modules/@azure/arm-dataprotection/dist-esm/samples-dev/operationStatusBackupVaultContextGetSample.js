...
function getOperationStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const operationId = "MjkxOTMyODMtYTE3My00YzJjLTg5NjctN2E4MDIxNDA3NjA2OzdjNGE2ZWRjLWJjMmItNDRkYi1hYzMzLWY1YzEwNzk5Y2EyOA==";
        const credential = new DefaultAzureCredential();
        const client = new DataProtectionClient(credential, subscriptionId);
        const result = yield client.operationStatusBackupVaultContext.get(resourceGroupName, vaultName, operationId);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=operationStatusBackupVaultContextGetSample.js.map