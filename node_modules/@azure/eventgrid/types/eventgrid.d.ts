...
export declare interface ApiCenterApiDefinitionAddedEventData {
...
export declare interface ApiCenterApiDefinitionUpdatedEventData {
    /** API definition title. */
    title: string;
    /** API definition description. */
    description: string;
...
/** API specification details. */
export declare interface ApiCenterApiSpecification {
    /** Specification name. */
    name: string;
