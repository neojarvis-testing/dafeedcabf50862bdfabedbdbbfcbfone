...
class FunctionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createFunctionResponse = protoFilesRoot.lookup('.google.cloud.functions.v2.Function');
        const createFunctionMetadata = protoFilesRoot.lookup('.google.cloud.functions.v2.OperationMetadata');
        const updateFunctionResponse = protoFilesRoot.lookup('.google.cloud.functions.v2.Function');
        const updateFunctionMetadata = protoFilesRoot.lookup('.google.cloud.functions.v2.OperationMetadata');
        const deleteFunctionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFunctionMetadata = protoFilesRoot.lookup('.google.cloud.functions.v2.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.functions.v2.FunctionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.functionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.functions.v2.FunctionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.functions.v2.FunctionService, this._opts, this._providedCustomServicePath);
