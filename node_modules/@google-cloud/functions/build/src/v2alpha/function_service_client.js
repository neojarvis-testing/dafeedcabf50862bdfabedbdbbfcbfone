...
class FunctionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createFunctionResponse = protoFilesRoot.lookup('.google.cloud.functions.v2alpha.Function');
        const createFunctionMetadata = protoFilesRoot.lookup('.google.cloud.functions.v2alpha.OperationMetadata');
        const updateFunctionResponse = protoFilesRoot.lookup('.google.cloud.functions.v2alpha.Function');
        const updateFunctionMetadata = protoFilesRoot.lookup('.google.cloud.functions.v2alpha.OperationMetadata');
        const deleteFunctionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFunctionMetadata = protoFilesRoot.lookup('.google.cloud.functions.v2alpha.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.functions.v2alpha.FunctionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.functionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.functions.v2alpha.FunctionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.functions.v2alpha.FunctionService, this._opts, this._providedCustomServicePath);
