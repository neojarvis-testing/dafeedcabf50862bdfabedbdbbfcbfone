 ...
 * @internal
 */
export interface WAFV2HttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<WAFV2ClientResolvedConfig, HandlerExecutionContext, WAFV2HttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultWAFV2HttpAuthSchemeParametersProvider: (config: WAFV2ClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<WAFV2HttpAuthSchemeParameters>;
/**
 * @internal
 */
