...
exports.removeInvalidArgs = exports.mergeOptions = exports.buildKeyConditionExpressions = exports.getExpressionAttributeValues = exports.getExpressionAttributeNames = exports.getUpdateExpression = exports.concatBatchFetchResult = exports.parseNewImageFromRecord = void 0;
/**
...
exports.parseNewImageFromRecord = parseNewImageFromRecord;
/**
...
exports.concatBatchFetchResult = concatBatchFetchResult;
/**
...
function getExpressionAttributeValues(rawNewFields, sortKeyOperator) {
    const newFields = removePlusFromFieldNames(rawNewFields);
...
function buildKeyConditionExpressions({ partitionKey, partitionKeyValue, sortKey, sortKeyOperator, sortKeyValue, }) {
    const keyValueObj = {};
...
exports.buildKeyConditionExpressions = buildKeyConditionExpressions;
/**
...
function mergeOptions(opt1, opt2) {
     ...
     */
    const combinedExpressionAttributeNames = Object.assign(Object.assign({}, opt1.ExpressionAttributeNames), opt2.ExpressionAttributeNames);
    const combinedExpressionAttributeValues = Object.assign(Object.assign({}, opt1.ExpressionAttributeValues), opt2.ExpressionAttributeValues);
    /**
     * Combine Expressions
     */
    ...
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, opt1), opt2), combinedExpressions), (combinedExpressionAttributeNames && {
...
exports.removeInvalidArgs = removeInvalidArgs;
