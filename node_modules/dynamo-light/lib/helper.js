...
function buildKeyConditionExpressions({ hashKey, hashKeyValue, sortKey, sortKeyOperator, sortKeyValue }) {
  const keyValueObj = {};
...
function mergeOptions(opt1, opt2) {
   ...
   */
  const combinedExpressionAttributeNames = Object.assign(
    {},
    opt1.ExpressionAttributeNames,
    opt2.ExpressionAttributeNames
  );
  const combinedExpressionAttributeValues = Object.assign(
    {},
